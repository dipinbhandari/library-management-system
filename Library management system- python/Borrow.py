        ...
        try:   
            ...
            try:
                if(int(ListSplit.quantity[a])>0):
                    ...
                    with open("dipinlibrarystock.txt","w+") as f:
                        for i in range(4):
                    ...
                    count=1
                    while loop==True:
                        print("Do you want to borrow more books? However you cannot borrow same book twice")
                        ...
                        if(choice.upper()=="Y"):
                            ...
                            print ("Thank you for borrowing books from library. ")
                            print("")
                            loop=False
                            success=True
                        else:
                            print("Please choose as command.")
                        
                else:
                    print("Book isn't available here.")
                    borrowBook()
                    success=False
            except IndexError:
                print("")
                print("Please choose book from above.")
        except ValueError:
            print("")
